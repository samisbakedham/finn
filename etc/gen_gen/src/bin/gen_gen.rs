...
use finn_miner_plugin as plugin;
use finn_store as store;
use finn_util::{self as util, ToHex};
use finn_wallet as wallet;

use finn_core::core::hash::Hashed;
use finn_core::core::verifier_cache::LruVerifierCache;
use finn_keychain::{BlindingFactor, ExtKeychain, Keychain};
...
fn main() {
...

	{
		...
		let tmp_chain = setup_chain(".finn.tmp", core::pow::mine_genesis_block().unwrap());
