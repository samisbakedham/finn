...
use finn_store::Error::NotFoundErr;
use finn_util::ToHex;
...
impl Chain {
	...
	/// Specific tmp dir.
	/// Normally it's ~/.finn/main/tmp for mainnet
	/// or ~/.finn/floo/tmp for floonet
	...
	pub fn txhashset_write(
		...
		// Write txhashset to sandbox (in the finn specific tmp dir)
