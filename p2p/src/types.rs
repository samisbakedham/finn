...
impl From<finn_store::Error> for Error {
	fn from(e: finn_store::Error) -> Error {
		Error::Store(e)
	}
}
...
/// included in finn-server.toml, but we don't want them to ever return none
impl P2PConfig {
	/// return ban window
