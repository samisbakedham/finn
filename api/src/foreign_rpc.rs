...
pub trait ForeignRpc: Sync + Send {
	...
	```
	# finn_api::doctest_helper_json_rpc_foreign_assert_response!(
	# r#"
	{
		"jsonrpc": "2.0",
		"method": "get_header",
	...
	*/
	...
	# r#"
	{
		"jsonrpc": "2.0",
		"method": "get_block_ex",
		"params": [374274, null, null, true, true],
		"id": 1
	}
	# "#
	# ,
	...
	*/
	...
	```
	# finn_api::doctest_helper_json_rpc_owner_assert_response!(
	# r#"
	{
		"jsonrpc": "2.0",
...
macro_rules! doctest_helper_json_rpc_foreign_assert_response {
	($request:expr, $expected_response:expr) => {
		// create temporary finn server, run jsonrpc request on node api, delete server, return
		// json response.

		{
			/*use finn_servers::test_framework::framework::run_doctest;
