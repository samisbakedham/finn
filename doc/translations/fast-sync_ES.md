...
En finn, llamamos "sync" al proceso de sincronizar un nuevo nodo o un nodo que no ha estado al día con la cadena durante un
...
de bloques, pero esto es problemático para finn ya que típicamente no descarga bloques completos..

En resumen, una sincronización rápida en finn hace lo siguiente:
