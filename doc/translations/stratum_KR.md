# finn Stratum RPC 프로토콜

이 문서는 finn에 구현되어 있는 현재 Stratum RPC protocol 을 설명한 것입니다.
...
***
채굴자에 의해 시작되는 메시지입니다.
채굴자는 보통 채굴 프로그램으로 고정적으로 정해지는 login, password, agent 로 finn Stratum 서버에 로그인 할 수 있습니다.
...
finn Stratum protocole 구현체는 다음과 같은 에러 메시지를 포함하고 있습니다.
...
현재 구현체는 [mimblewimble/finn-miner](https://github.com/mimblewimble/finn-miner/blob/master/src/bin/client.rs) 에서 참고하세요.
