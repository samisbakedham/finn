...
A design goal of finn is that all structures be as easy to implement and
...
are simple to specify (no scripts) and finn is written in a language with
...
finn itself does not need proof-of-spentness but it is a good thing to support
