...
This document describes some of the basic functionality and requirements of finn's transaction pool.
...
Given the focus of finn (and mimblewimble) on reduced resource consumption, the memory pool should be an optional but recommended component for non-mining nodes.
