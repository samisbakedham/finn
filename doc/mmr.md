...
their 2 children. finn uses the Blake2b hash function throughout, and always
...
In finn, a lot of the data that gets hashed and stored in MMRs can eventually
