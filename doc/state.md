...
The full state of a finn chain consists of all the following data:
...
With a full finn state, we can validate the following:
...
Data storage for outputs, range proofs and kernels in finn is simple: a plain
