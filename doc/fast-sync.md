...
In finn, we call "sync" the process of synchronizing a new node or a node that
...
by other blockchains, but this is problematic for finn as it typically does not
download full blocks.

In short, a fast-sync in finn does the following:
