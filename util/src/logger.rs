...
impl Default for LoggingConfig {
	fn default() -> LoggingConfig {
		LoggingConfig {
			...
			log_file_path: String::from("finn.log"),
...
/// This filter is rejecting messages that doesn't start with "finn"
/// in order to save log space for only finn-related records
#[derive(Debug)]
struct finnFilter;

impl Filter for finnFilter {
