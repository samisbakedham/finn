...
//! patterns that are frequent within the finn codebase.
...
/// Global stopped/paused state shared across various subcomponents of finn.
///
/// "Stopped" allows a clean shutdown of the finn server.
